...
//import cn.edu.thu.log.connections.logmodel.LogPetrinetConnection;
//import cn.edu.thu.log.connections.logmodel.LogPetrinetConnectionImpl;
...
public class ReplayFitnessPlugin {
	...
	public ReplayFitness getFitness(XLog log, Petrinet net,
		...
		System.out.println("Marking size："+marking.size());
		// return null;
		// }
	...
	public ReplayFitness getFitness(XLog log, Petrinet net, Marking marking,
		...
		// LogPetrinetConnection logpetrinetconnection=new
		// LogPetrinetConnectionImpl(log, classes, net, map);
