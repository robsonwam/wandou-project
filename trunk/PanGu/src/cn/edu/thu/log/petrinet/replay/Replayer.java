...
import cn.edu.thu.log.mining.alphamining.InitContext;
...
//	private final PluginContext context;
	 ...
	 */
	public Replayer(Petrinet net, PetrinetSemantics semantics,
			Map<Transition, ? extends Object> map, ReplayCostAddOperator<C> addOperator) {
		this.init=new InitContext();	
		this.net = net;
	...
	public List<Transition> replayTrace(Marking initialMarking, List<? extends Object> trace, ReplaySettings<C> settings)
		 ...
		 * Start the search.
		 */
		searcher.startSearch(init.getExecutor(), finalStates);
