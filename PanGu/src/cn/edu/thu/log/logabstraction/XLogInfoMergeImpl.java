 ...
 *
 */
public class XLogInfoMergeImpl implements XLogInfo {
	...
	public static XLogInfo create(XLog log, XEventClassifier defaultClassifier, 
		...
		return new XLogInfoMergeImpl(log, defaultClassifier, classifiers);
	}
	 ...
	 */
	public XLogInfoMergeImpl(XLog log, XEventClassifier defaultClassifier, Collection<XEventClassifier> classifiers) {
		this.log = log;
		...
		this.eventClasses.put(XLogInfoMergeImpl.NAME_CLASSIFIER, new XEventClasses(XLogInfoMergeImpl.NAME_CLASSIFIER));
		this.eventClasses.put(XLogInfoMergeImpl.RESOURCE_CLASSIFIER, new XEventClasses(XLogInfoMergeImpl.RESOURCE_CLASSIFIER));
		this.eventClasses.put(XLogInfoMergeImpl.LIFECYCLE_TRANSITION_CLASSIFIER, new XEventClasses(XLogInfoMergeImpl.LIFECYCLE_TRANSITION_CLASSIFIER));
	...
	public XLogInfoMergeImpl(Object[] infoParameter){
	...
	public XEventClasses getResourceClasses() {
		return getEventClasses(XLogInfoMergeImpl.RESOURCE_CLASSIFIER);
	}
	...
	public XEventClasses getNameClasses() {
		return getEventClasses(XLogInfoMergeImpl.NAME_CLASSIFIER);
	}
	...
	public XEventClasses getTransitionClasses() {
		return getEventClasses(XLogInfoMergeImpl.LIFECYCLE_TRANSITION_CLASSIFIER);
	}
